            ...
            <thead>
              <tr>
                ...
                <th className="hand" onClick={sort('producer')}>
                  Producer <FontAwesomeIcon icon="sort" />
                </th>
            ...
            <tbody>
              {deviceList.map((device, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>
                    {device.createdDate ? (
                      <TextFormat value={device.createdDate} type="date" format={APP_DATE_FORMAT} blankOnInvalid />
                    ) : null}
                  </td>
                  <td>{device.lastModifiedBy}</td>
                  <td>
                    {device.lastModifiedDate ? (
                      <TextFormat value={device.lastModifiedDate} type="date" format={APP_DATE_FORMAT} blankOnInvalid />
                    ) : null}
                  </td>
